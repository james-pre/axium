...
<div id="sidebar">
	...
	<button id="new">
		<div>
			<svg class="icon before" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
				<path
	...
	<button data-item="trash" class={sidebar.active === 'trash' ? 'active' : ''} onclick={() => switchTo('trash')}>
		<div>
			<svg class="icon before" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
				<path
